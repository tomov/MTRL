...
env.phi{5} = [0 0.3 0 -0.1];
env.phi{6} = [1 0 0 -0.5];
env.phi{7} = [0.1 0.1 2 -0.3];

env.phi{8} = [0.9 0 0 -0.5];
env.phi{9} = [0.8 0.8 1.6 -0.8];
env.phi{10} = [0 0.9 0 -0.5];

env.phi{11} = [0 0 0 0];
env.phi{12} = [0 1 1.6 -0.5];
env.phi{13} = [0 0 0 0];
