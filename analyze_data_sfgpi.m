...
% v1_2a
design_params.n_blocks = 5;
design_params.n_train_trials = 60;
design_params.n_trials_per_block = 61;
design_params.action_paths = { ...
    '1 1', ...
    '1 2', ...
    '1 3', ...
...
% v1_3a
design_params.n_blocks = 6;
design_params.n_train_trials = 48;
design_params.n_trials_per_block = 49;
design_params.action_paths = { ...
    '1 1 2', ...
    '1 2 2', ...
    '1 3 2', ...
...
% v1_4a
design_params.n_blocks = 2;
design_params.n_train_trials = 146;
design_params.n_trials_per_block = 147;
design_params.action_paths = { ...
'1 1 1', ...
'1 1 2', ...
'1 1 3', ...
...
%[data, Ts, filenames] = load_data_sfgpi('exp/results/sfgpi_v1_2a', design_params);
%[data, Ts, filenames] = load_data_sfgpi('exp/results/sfgpi_v1_3a', design_params);
[data, Ts, filenames] = load_data_sfgpi('exp/results/sfgpi_v1_4a', design_params);
